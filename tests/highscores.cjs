...
(async()=>{
  ...
  for(const [game,version] of Object.entries(context.SkolarkadenHighscorePolicy.versions))assert.equal(version,['eggs','city','food','garden','hive'].includes(game)?'v2':'v1');
