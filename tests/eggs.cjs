...
for(const f of ['pinyin','data','word-pairs','speech','input','people','game','plants','garden','eggs'])vm.runInContext(fs.readFileSync(path.join(__dirname,'../resources/'+f+'.js'),'utf8'),ctx,{filename:f+'.js'});
