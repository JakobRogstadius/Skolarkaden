...
for(const file of ['pinyin','data','word-pairs','voice','speech','input','people','game','paint'])vm.runInContext(fs.readFileSync(path.join(__dirname,'../resources/'+file+'.js'),'utf8'),ctx,{filename:file+'.js'});
