...
http.createServer((req,res)=>{
  ...
  if(!['index.html','statistics.html','homework.html','homework.json','language-exercises.json'].includes(relative)&&!/^resources\/[\w.-]+$/.test(relative)){res.writeHead(404).end();return;}
